...
En la [nota anterior](https://pamepairo.netlify.app/post/7-12-2020-motivos-pagina-web/) te comentamos algunas ventajas de tener una página web personal. También, resumimos en un esquema los 3 partes en las que se puede dividir el proceso. A continuación nos explayaremos en cada parte y construiremos la página web personal.
...
blogdown::new_site(theme = "gcuschen/hugo-academic", theme_example = TRUE)# en theme se debe colocar el nombre de la plantilla de hugo elegida 
```
